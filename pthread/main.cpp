...
int main()
{
	...
	for (int i = 0; i < vec.size(); i++)
	{
		...
		fout.close();
		if(!check_res()){
            cout<<"error with pt_sse_row"<<endl;
            break;
		}
		...
		fout.close();
		if(!check_res()){
            cout<<"error with pt_sse_col"<<endl;
            break;
		}
		...
		fout.close();
		if(!check_res()){
            cout<<"error with pt_avx_row"<<endl;
            break;
		}
